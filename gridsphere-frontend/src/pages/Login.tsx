    ...
    >
      <div className="w-full max-w-md bg-white rounded-2xl shadow-card border border-gray-200 p-6 sm:p-8">
        ...
        <div className="mb-5 sm:mb-6">
          <p className="text-[10px] sm:text-xs font-bold uppercase tracking-widest text-brand-600 mb-1">Access Panel</p>
          <h2 className="text-xl sm:text-2xl font-extrabold text-gray-900">Welcome back!</h2>
          <p className="text-xs sm:text-sm text-ink-dim mt-1">Sign in to access your AgriSense Ecosystem.</p>
        </div>
