...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-linear-to-b from-brand-600 via-brand-600 to-bg px-4 py-12">
      <form onSubmit={handleSubmit} className="w-full max-w-md bg-white rounded-2xl shadow-card p-8">
        <p className="text-xs font-bold uppercase tracking-widest text-brand-600 mb-1">Access Panel</p>
        ...
        <p className="text-sm text-ink-dim text-center mt-5">
          No station account yet? <Link to="/register" className="text-brand-600 font-bold">Register one</Link>
        </p>
      </form>
    </div>
  );
